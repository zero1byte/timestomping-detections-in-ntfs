...
# Security: Valid extraction_id pattern (DRIVE_YYYYMMDD_HHMMSS)
...
class ConvertRequest(BaseModel):
    ...
    def validate_extraction_id(cls, v):
        if not EXTRACTION_ID_PATTERN.match(v):
            raise ValueError('Invalid extraction_id format. Expected: DRIVE_YYYYMMDD_HHMMSS (e.g., C_20260301_143022)')
        return v
